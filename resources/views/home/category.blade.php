...
<div class="my-6 mx-3 grid grid-flow-row grid-cols-3 grid-rows-3 gap-4">
    <div class="w-auto"><img src="https://placehold.jp/f71b1b/ffffff/350x180.png?text={{ urlencode('クリスマス') }}"></div>
    <div class="w-auto"><img src="https://placehold.jp/f71b1b/ffffff/350x180.png?text={{ urlencode('正月') }}"></div>
